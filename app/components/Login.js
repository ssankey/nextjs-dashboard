...
export default function Example() {
    return (
      ...
      <div className="flex flex-col sm:flex-row h-full">
          <div className="lg:w-1/2  h-1/4 flex justify-center items-center sm:h-full w-full font-black bg-black">
            <h1 className="text-white text-[72px] ">Board.</h1>
          </div>
          <div className="bg-gray-300 lg:w-1/2 h-3/4  sm:h-full  flex flex-col justify-center sm:p-[5rem] items-center">
              ...
              <div className="flex sm:w-[450px]  flex-col sm:flex-row justify-between mb-4">
                  <button onClick={()=>signIn('google')} className="flex items-center sm:w-[200px] w-full mb-5 sm:m-0 justify-center sm:px-4 px-5 py-2 bg-white rounded-[10px]">
                      ...
                      <span className="text-[#858585] ml-2 text-[12px]">Sign in with Google</span>
                      
                  </button>
                  <button className="flex items-center w-[200px]  justify-center px-4 py-2 bg-white rounded-[10px]">
                  ...
                  <span className="text-[#858585] ml-2 text-[12px]">Sign in with Apple</span>
                  </button>           
              </div>
              <div className=" sm:w-[450px] p-10 bg-white rounded-[20px] shadow"> 
                  <div className="mb-4">
                  ...
                  <div className="mb-4">
                    <label className="block text-[16px] font-medium text-black mb-1" htmlFor="password">
                      Password
                    </label>
                    <input
                      className="w-full px-3 py-2 border bg-[#EAEAEA] border-gray-300 rounded-[10px]"
    ...
    {/* <div className="flex flex-col sm:flex-row h-screen">
      <div className="bg-black sm:w-1/2 h-1/2 sm:h-auto w-full">

      </div>
      <div className="bg-gray-300 sm:w-1/2 h-1/2 sm:h-auto w-full">
